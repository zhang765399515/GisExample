...
import { Color, Cartesian3, CallbackProperty } from 'geokey-gis';
...
onMounted(() => {
  setTimeout(() => {
    ...
    window.viewer.camera.flyTo({
      destination: {
        x: -2463898.149017091,
        y: 5484490.8706539795,
        z: 2477700.0580879403
      },
      orientation: {
        heading: 0.057746270523065135,
        pitch: -1.3100556895013113,
        roll: 0.000005114295109187594
      },
      duration: 1
    });
  }, 2000);
