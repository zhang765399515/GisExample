import { Color, Cartesian3, GeometryInstance , PolylineGeometry,PolylineMaterialAppearance,Material,Primitive} from 'geokey-gis';
import imgUrl from "@/assets/img/19_2.png"
    ...
    fabric: {
      ...
      source: `
          czm_material czm_getMaterial(czm_materialInput materialInput) {
            ...
            // 转换纹理坐标分量 st.s(st.s:s 表示沿线的方向,st.t:t表示垂直于线的方向)、范围0~1
            //st_map_s范围0~1,speed 来源于 fabric.uniforms.speed
            ...
            // 更新材质，设置透明度（图片颜色的透明度和外部变量color中的颜色透明度）
