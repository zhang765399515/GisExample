import { SceneView, geoWMTSLayer, WebMapTileServiceImageryProvider, SceneMode } from 'geokey-gis';
...
export function initMap(domRef: Element) {
  ...
  viewer.scene.imageryLayers.addImageryProvider(
    new WebMapTileServiceImageryProvider({
      url: 'http://basemap.igeokey.com:12023/basemap/gis/getTdtMap/163028b5f90eb2f64439c4d81349b5b6/11/tile/{TileMatrix}/{TileRow}/{TileCol}',
      layer: '',
      style: 'default',
      format: 'image/jpeg',
