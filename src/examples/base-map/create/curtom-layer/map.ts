import { SceneView, UrlTemplateImageryProvider, TileMapServiceImageryProvider, SceneMode } from 'geokey-gis';
...
export function initMap(domRef: Element) {
  ...
  viewer.scene.imageryLayers.addImageryProvider(
     TileMapServiceImageryProvider.fromUrl('http://14.22.86.227:12022/service/gis/3DModel/?serviceName=sz_yingxiang&uuid=1')
  );
